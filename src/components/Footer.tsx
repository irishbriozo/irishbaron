      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-4 xl:col-span-1" id="footer-brand-section">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-stone-400">
              Savoring moments, steaming heritage. We provide premium Philippine coffee brews, comforting canteen meals, and specialty hand-cooked kakanin for students, staff, and our community.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul className="mt-4 space-y-2.5 text-sm">
                  ...
                  <li className="text-stone-400 flex items-center gap-2">
                    <span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-600"></span>
                    Flexible Event Catering
                  </li>
                  <li className="text-stone-400 flex items-center gap-2">
                    <span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-600"></span>
                    Canteen Dining Wait-list
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-stone-400" id="footer-contacts">
                <li className="flex items-start space-x-2.5">
                  ...
                  <span>GK College Canteen, CMDI Boulevard, Biñan, Laguna, Philippines</span>
                </li>
                ...
                <li className="flex items-center space-x-2.5">
                  ...
                  <span>gkcoffee.primo@canteen.com</span>
                </li>
                <li className="flex items-start space-x-2.5">
        ...
        <div className="mt-12 border-t border-stone-850 pt-8 flex flex-col md:flex-row md:items-center md:justify-between text-xs text-stone-500">
          <p id="footer-copyright-text">
            &copy; {currentYear} GK Coffee By Primo. All rights reserved. Registered School Canteen Provider.
          </p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            <a href="#" className="hover:text-stone-300">Privacy Policy</a>
            <a href="#" className="hover:text-stone-300">Canteen Rules</a>
